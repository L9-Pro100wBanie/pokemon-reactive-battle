...
function App() {
  ...
  // Sprawdzamy przy uruchomieniu, czy ktoś jest zalogowany
  useEffect(() => {
  ...
  return (
    <BrowserRouter>
      {/* Pasek nawigacji widoczny tylko dla zalogowanych */}
      {isAuthenticated && (
      ...
      <Routes>
        {/* Jeśli niezalogowany - idzie do logowania, jeśli zalogowany - od razu do drużyny */}
        <Route 
          path="/" 
